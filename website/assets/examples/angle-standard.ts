...
const radiansConfig : Configuration = {
  radius: 150,
  width: 400,
  margin:50,
  radians: true,
...
const degreesConfig : Configuration = {
  radians: false,
  tics: 180,
  ticStepBig: 5,
  labelStep: 15,
...
export class StandardAngleExample extends PlayerLayout {
    ...
    let figure = new ResponsiveArtboard(this.canvas, {
      width: 300,
      height: 300,
      align: 'left'
    })
    figure.drawGrid(false, false);
...
// export class StandardAngleFigureBase extends ResponsiveArtboard {
