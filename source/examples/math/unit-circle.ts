...
import {Interactive, BaseElement, Point } from '../../index.js';
...
class UnitCircle {
  ...
  constructor( id:string, angle:number, func:(x:number) => number = Math.cos) {
...
*/
export default function main( id:string, opts:InteractiveOptions ) {
